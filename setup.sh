...
python3 -m uv pip install -U -r dependencies/requirements/generated_requirements/requirements.txt || echo "Failed to install dependencies in the requirements" >&2
