...
This implementation reimplements routing, token placement, and kernel execution for Wan in MaxDiffusion. The [original SVG implementation](https://github.com/svg-project/Sparse-VideoGen) provides the reference method.
