...
class CNN(nn.Module):
  ...
  def __call__(self, x):
    ...
    # Custom gradient is not supported for conv.
    if self.weights_quant_mode == utils.QuantMode.TRAIN:
      aqt_conv = None
    else:
      aqt_cfg_conv = copy.deepcopy(self.aqt_cfg)
...
def train_epoch(state, train_ds, batch_size, rng):
  ...
  for perm in perms:
    ...
    print('SS ======== train_epoch update model',
