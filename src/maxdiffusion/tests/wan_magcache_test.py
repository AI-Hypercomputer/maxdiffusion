  ...
  def setUpClass(cls):
    pyconfig.initialize(
        [
            ...
            'flash_block_sizes={"block_q":3024,"block_kv_compute":1024,"block_kv":2048,"block_q_dkv":3024,"block_kv_dkv":2048,"block_kv_dkv_compute":1024,"use_fused_bwd_kernel":false}',
        ],
        unittest=True,
    )
