...
config_path = "src/maxdiffusion/configs/base_flux2klein_9B.yml"
print(f"Initializing pyconfig with: {config_path}")
pyconfig.initialize([
    None,
    config_path,
    "run_name=test_9b_e2e_parity",
    "output_dir=/tmp/",
...
def run_parity():
  ...
  # Inputs
  prompt = "A stunt car driving in a stadium"
  width = 512
  height = 512
  ...
  pt_fp32_path = "src/maxdiffusion/tests/flux2klein/images/stunt_9b_pytorch_fp32.png"
  pt_bf16_path = "src/maxdiffusion/tests/flux2klein/images/stunt_9b_pytorch_bf16.png"
  jax_bf16_path = "src/maxdiffusion/tests/flux2klein/images/stunt_9b_jax_bf16.png"
  ...
  # -------------------------------------------------------------------------
  print("\n" + "=" * 80)
  print("📊 9B MODEL END-TO-END PARITY REPORT")
  print("=" * 80)
  ...
  md_report_path = "src/maxdiffusion/tests/flux2klein/flux9b_streamlined_e2e_report.md"
  with open(md_report_path, "w") as f:
    f.write(
        f"""# 📈 Flux.2-klein-9B Streamlined E2E Parity Report
...
*   **Golden PyTorch FP32**: [stunt_9b_pytorch_fp32.png](file://{os.path.abspath(pt_fp32_path)})
*   **PyTorch CPU BF16**: [stunt_9b_pytorch_bf16.png](file://{os.path.abspath(pt_bf16_path)})
*   **JAX TPU BF16**: [stunt_9b_jax_bf16.png](file://{os.path.abspath(jax_bf16_path)})
"""
    )
