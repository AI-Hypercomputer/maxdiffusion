...
class EulerDiscreteSchedulerState:
  ...
  @classmethod
  def create(cls, common: CommonSchedulerState, init_noise_sigma: jnp.ndarray, timesteps: jnp.ndarray, sigmas: jnp.ndarray):
...
class FlaxEulerDiscreteScheduler(FlaxSchedulerMixin, ConfigMixin):
  ...
  def set_timesteps(
      self, state: EulerDiscreteSchedulerState, num_inference_steps: int, shape: Tuple = (), timestep_spacing: str = ""
