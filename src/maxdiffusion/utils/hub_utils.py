...
def http_user_agent(user_agent: Union[Dict, str, None] = None) -> str:
    ...
    """
    ua = f"maxdiffusion/{__version__}; python/{sys.version.split()[0]}; session_id/{SESSION_ID}"
    ...
    if os.environ.get("MAXDIFFUSION_IS_CI", "").upper() in ENV_VARS_TRUE_VALUES:
        ua += "; is_ci/true"
...
old_diffusers_cache = os.path.join(hf_cache_home, "maxdiffusion")
...
class PushToHubMixin:
    ...
    def push_to_hub(
        ...
        ```python
        from maxdiffusion import UNet2DConditionModel
