...
class AttentionOp(nn.Module):
  ...
  cudnn_flash_axis_names: AxisNames = (BATCH, LENGTH, HEAD, D_KV)
...
class FlaxFluxAttention(nn.Module):
  ...
  query_axis_names: AxisNames = (KV_BATCH, KV_HEAD, LENGTH, KV_HEAD_DIM)
  key_axis_names: AxisNames = (KV_BATCH, KV_HEAD, LENGTH, KV_HEAD_DIM)
  value_axis_names: AxisNames = (KV_BATCH, KV_HEAD, LENGTH, KV_HEAD_DIM)
