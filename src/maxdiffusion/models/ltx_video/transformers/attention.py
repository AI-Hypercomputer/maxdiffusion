...
class BasicTransformerBlock(nn.Module):
    ...
    def __call__(
        ...
        attn_output = nn.with_logical_constraint(
            attn_output, ("activation_batch", "activation_norm_length", "activation_embed")
        )
        ...
        if self.attn2 is not None:
            ...
            attn_input = nn.with_logical_constraint(
                attn_input, ("activation_batch", "activation_norm_length", "activation_embed")
            )
        ...
        ff_output = nn.with_logical_constraint(
            ff_output, ("activation_batch", "activation_norm_length", "activation_embed")
        )
    ...
    def __call__(
        ...
        **cross_attention_kwargs,
        ...
        if skip_layer_mask is not None:
            skip_layer_mask = jnp.reshape(skip_layer_mask[block_index], (batch_size, 1, 1))  #here skip_layer_mask is (48,3), changed this currently!
