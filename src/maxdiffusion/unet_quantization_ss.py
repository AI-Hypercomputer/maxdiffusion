...
def tree_memory_per_device(tree) -> int:
...
def get_quantized_unet_variables(config):
  ...
  print('***** SS **** orig memory', tree_memory_per_device(quantized_unet_vars))
  quantized_unet_vars["params"] = remove_quantized_params(
    quantized_unet_vars["params"], quantized_unet_vars["aqt"])
  print('***** SS **** removed memory', tree_memory_per_device(quantized_unet_vars))
  quantized_unet_vars = {
    "params": quantized_unet_vars["params"],
    "aqt": quantized_unet_vars["aqt"]
  }
  print('***** SS **** pruned memory', tree_memory_per_device(quantized_unet_vars))
  pipeline.save_pretrained(
            ...
            params={
                ...
                # "unet": get_params_to_save(quantized_unet_vars),
                "unet": quantized_unet_vars,
            },
        )
