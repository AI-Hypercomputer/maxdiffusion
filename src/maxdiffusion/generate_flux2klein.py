...
def load_and_convert_weights(safetensors_path, params):
    """
    ...
    # 5 Double Blocks
    print("Mapping 5 double-stream attention blocks...")
    ...
    # 20 Single Blocks
    print("Mapping 20 single-stream attention blocks...")
...
def main(argv):
    ...
    with jax.default_device(cpu_device):
        with mesh, nn_partitioning.axis_rules(config.logical_axis_rules):
            ...
            params = load_and_convert_weights(safetensors_path, params)
