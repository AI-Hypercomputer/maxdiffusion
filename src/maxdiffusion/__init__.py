...
# When adding a new object to this init, please add it to `_import_structure`.
# The `_import_structure` is a dictionary submodule to list of object names,
# and is used to defer the actual importing for when the objects are requested.
# This way `import diffusers` provides the names in the namespace without
# actually importing anything (and especially none of the backends).
