...
default_prompt = (
    "a colorful photo of a castle in the middle of a forest with trees and bushes, "
    "by Ismail Inceoglu, shadows, high contrast, dynamic shading, hdr, "
    "detailed vegetation, digital painting, digital drawing, detailed painting, "
    "a detailed digital painting, gothic art, featured on deviantart"
)
...
start = time.time()
prompt = (
    "photo of a rhino dressed suit and tie sitting at a table in a bar with a bar "
    "stools, award winning photography, Elke vogelsang"
)
...
start = time.time()
prompt = (
    "photo of a rhino dressed suit and tie sitting at a table in a bar with a "
