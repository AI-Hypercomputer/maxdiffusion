...
# custom_splash imported in custom_ring.py
...
# Re-export custom ring attention for 100% backwards compatibility
from maxdiffusion.models.attention_strategies.custom_ring import (  # noqa: F401
