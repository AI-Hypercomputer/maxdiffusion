...
def run_inference_fori_2_2_i2v(
    graphdef,
    low_noise_state,
    low_noise_rest,
    high_noise_state,
  ...
  """Denoising loop for WAN 2.2 I2V using jax.lax.fori_loop.

  The entire denoising loop runs as a single XLA program. Dual-transformer
  selection uses jax.lax.cond. I2V-specific: condition is concatenated with
  latents and image_embeds (may be None) is passed to the transformer.
  """
  bsz = latents.shape[0]
