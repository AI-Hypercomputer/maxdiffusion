...
class FlaxDiffusionPipeline(ConfigMixin, PushToHubMixin):
  ...
  def register_modules(self, **kwargs):
    ...
    from maxdiffusion import pipelines
  ...
  def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
    ...
    ```py
    >>> from maxdiffusion import FlaxDiffusionPipeline
    ...
    if not os.path.isdir(pretrained_model_name_or_path):
      ...
      if cls != FlaxDiffusionPipeline:
        ...
        requested_pipeline_class = (
            requested_pipeline_class if requested_pipeline_class.startswith("Flax") else "Flax" + requested_pipeline_class
        )
