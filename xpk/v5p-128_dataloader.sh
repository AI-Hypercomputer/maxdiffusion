...
git clone -b aireen/mlperf_4_data https://github.com/google/maxdiffusion.git
cd maxdiffusion
pip install .

TPU_STDERR_LOG_LEVEL=0 TPU_MIN_LOG_LEVEL=0 TF_CPP_MIN_LOG_LEVEL=0 python -m src.maxdiffusion.models.standalone_dataloader src/maxdiffusion/configs/base_2_base.yml run_name=v5p-data base_output_directory=${OUT_DIR}  \
...
enable_profiler=false skip_first_n_steps_for_profiler=495 reuse_example_batch=false max_train_steps=500  2>&1 | tee /tmp/SD_test_log
